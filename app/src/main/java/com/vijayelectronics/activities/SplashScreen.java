        ...
        if (appSettings != null) {
          ...
          /*  if (appSettings.getCurrencyName() != null  &&  !TextUtils.isEmpty(appSettings.getCurrencyName())) {
            ...
            */
            ...
            ConstantValues.CURRENCY_SYMBOL = "₹";
            ConstantValues.FILTER_MAX_PRICE = "1000";
            ConstantValues.NEW_PRODUCT_DURATION = 20;
            ...
            ConstantValues.DEFAULT_HOME_STYLE = getString(R.string.actionHome) + " " + 7;
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equalsIgnoreCase("0")) {
                ...
                if (myAppPrefsManager.isFirstTimeLaunch()) {
                    ...
                    if ((strProduct != null && !strProduct.isEmpty()) || (strSellerInfo != null && !strSellerInfo.isEmpty())) {
