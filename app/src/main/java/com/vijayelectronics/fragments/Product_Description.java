...
import com.vijayelectronics.activities.Login;
import com.vijayelectronics.activities.MainActivity;
import com.vijayelectronics.adapters.GroupedProductsAdapter;
import com.vijayelectronics.adapters.ProductAdapter;
import com.vijayelectronics.adapters.ProductAttributesAdapter;
import com.vijayelectronics.adapters.ProductReviewsAdapter;
...
import com.vijayelectronics.customs.DividerItemDecoration;
import com.vijayelectronics.databases.User_Favorites_DB;
import com.vijayelectronics.models.api_response_model.ErrorResponse;
import com.vijayelectronics.models.cart_model.CartDetails;
import com.vijayelectronics.models.device_model.AppSettingsDetails;
import com.vijayelectronics.models.product_model.ProductAttributes;
import com.vijayelectronics.models.product_model.ProductDetails;
import com.vijayelectronics.models.product_model.ProductImages;
...
import com.vijayelectronics.utils.DeepLinking;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            if (getArguments().containsKey("itemID")) {
                ...
                if (appSettings != null && "1".equalsIgnoreCase(appSettings.getDokan_enabled())) {
                ...
                } else if (appSettings != null && "2".equalsIgnoreCase(appSettings.getDokan_enabled())) {
                    seller_div.setVisibility(View.VISIBLE);
        ...
        call.enqueue(new Callback<SellerDetailModel>() {
            ...
            public void onResponse(Call<SellerDetailModel> call, Response<SellerDetailModel> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    seller_email = sellerDetailModel.getEmail();
