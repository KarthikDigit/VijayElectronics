...
import com.vijayelectronics.customs.EndlessRecyclerViewScroll;
import com.vijayelectronics.customs.FilterDialog;
import com.vijayelectronics.models.api_response_model.ErrorResponse;
import com.vijayelectronics.models.product_filters_model.FilterDetails;
import com.vijayelectronics.models.product_filters_model.PostFilters;
...
//                String str = new Gson().toJson(response.body());
    ...
    public void RequestFilteredProducts(final int pageNumber, PostFilters filters) {
        ...
        if (filters.getMaxPrice() != null  &&  !TextUtils.isEmpty(filters.getMaxPrice())  &&  !"0".equalsIgnoreCase(filters.getMaxPrice()))
            params.put("max_price_new", ""+filters.getMaxPrice());
        
        if (filters.getMinPrice() != null  &&  !TextUtils.isEmpty(filters.getMinPrice()))
            params.put("min_price_new", ""+filters.getMinPrice());
    ...
    public void RequestProducts(List<Integer> products) {
        ...
        Log.e(TAG, "RequestProducts: "+new Gson().toJson(params) );
