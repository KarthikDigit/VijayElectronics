...
import com.vijayelectronics.adapters.CouponsAdapter;
import com.vijayelectronics.adapters.DemoCouponsListAdapter;
...
import com.vijayelectronics.models.order_model.OrderProducts;
  ...
  /*      scratchTextView.setRevealListener(new ScratchTextView.IRevealListener() {
    ...
    public void updateCart() {
        ...
        for (int i = 0; i < cartItemsList.size(); i++) {
            subtotal += Double.parseDouble(TextUtils.isEmpty(cartItemsList.get(i).getPrice()) ? "0" : cartItemsList.get(i).getPrice()) * GetItemQTY(cartItemsList.get(i).getId());
        }


        for (int x = 0; x < cartItemsList.size(); x++) {
            double setTotalPrice = Double.parseDouble(TextUtils.isEmpty(cartItemsList.get(x).getPrice()) ? "0" : cartItemsList.get(x).getPrice()) * GetItemQTY(cartItemsList.get(x).getId());
