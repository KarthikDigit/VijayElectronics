...
//        headerListText.setTypeface(Typeface.DEFAULT, Typeface.BOLD);
        headerListText.setText(Utilities.getFirstLetterCaps(group.getTitle()));

//        Utilities.setCustomFonts(this.context, headerListText);
    ...
    public View getChildView(int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        childListText.setText(Utilities.getFirstLetterCaps(child.getTitle()));


//        Utilities.setCustomFonts(this.context, childListText);
